...
We will provide travel grants to a small number of students and postdocs. If you are interested in participating and do not have funds to travel consider applying.

## Application {#application}

Submit the following application materials to `mj.junca20@uniandes.edu.co`:

-   A one-page Statement of purpose (in a PDF) explaining why you would like to attend this workshop. Send your statement in an email with the subject: `Travel grant <your_name>`.
